...
def resize2():
    set_seed(42)
    root = 'D:\ISIC2017\ISIC-2017_Training_Data\ISIC-2017_Training_Data'
    b1 = [i for i in os.listdir(os.path.join(root)) if i.endswith(".jpg")]
    b1.sort()
    root1 = 'D:\ISIC2017\ISIC-2017_Training_Part1_GroundTruth\ISIC-2017_Training_Part1_GroundTruth'
    ...
    rootval = 'D:\ISIC2017\ISIC-2017_Validation_Data\ISIC-2017_Validation_Data'
    b3 = [i for i in os.listdir(os.path.join(rootval)) if i.endswith(".jpg")]
    b3.sort()
    rootval1 = 'D:\ISIC2017\ISIC-2017_Validation_Part1_GroundTruth\ISIC-2017_Validation_Part1_GroundTruth'
    ...
    rootest = 'D:\ISIC2017\ISIC-2017_Test_v2_Data\ISIC-2017_Test_v2_Data'
    b5 = [i for i in os.listdir(os.path.join(rootest)) if i.endswith(".jpg")]
    b5.sort()
    rootest1 = 'D:\ISIC2017\ISIC-2017_Test_v2_Part1_GroundTruth\ISIC-2017_Test_v2_Part1_GroundTruth'
    ...
    for i, (image_path, labels) in enumerate(zip(image_root, label_root)):
        ...
        img.save(os.path.join("./2017/train/image", f'{b1[i].split(".")[0]}.png'))
    ...
    for i, (image_path, labels) in enumerate(zip(image_root2, label_root2)):
        ...
        img = img.resize((224, 224), Image.NEAREST)
        label1 = label1.resize((224, 224), Image.NEAREST)
        img.save(os.path.join("./2017/val/image", f'{b3[i].split(".")[0]}.png'))
    ...
    for i, (image_path, labels) in enumerate(zip(image_root1, label_root1)):
        ...
        img = img.resize((224, 224), Image.NEAREST)
        label1 = label1.resize((224, 224), Image.NEAREST)
        img.save(os.path.join("./2017/test/image", f'{b5[i].split(".")[0]}.png'))
